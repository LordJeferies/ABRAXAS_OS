...
<body class="landing-story-body">
  ...
  <main id="story-scroll-container" class="story-scroll-container">
    ...
    <!-- CANONICAL CORPUS (37 FILES EXPLAINED IN DEPTH) -->
    <section id="corpus-canonico" class="canonical-corpus-section" style="max-width: 1100px; margin: 5rem auto; padding: 3.5rem 2.5rem; background: rgba(8, 12, 20, 0.92); border: 1px solid rgba(212, 175, 55, 0.4); border-radius: 16px; backdrop-filter: blur(20px); box-shadow: 0 24px 64px rgba(0,0,0,0.85);">
      ...
      <div style="text-align: center; margin-bottom: 3rem;">
        <span style="font-family: monospace; font-size: 11px; font-weight: 800; color: #d4af37; letter-spacing: 0.15em; background: rgba(212,175,55,0.15); padding: 4px 14px; border-radius: 20px; border: 1px solid rgba(212,175,55,0.3);">
          ${locale === 'en' ? 'CANONICAL KNOWLEDGE BASE // 37 DOSSIERS' : 'BASE DE CONOCIMIENTO CANÓNICA // 37 DOSSIERS'}
        </span>
        <h2 style="font-size: 2.3rem; font-weight: 800; color: #fff; margin: 14px 0 8px 0; letter-spacing: -0.02em;">
          ${locale === 'en' ? 'The Complete Architecture: 37 Master Dossiers' : 'La Arquitectura Completa: Los 37 Archivos del Canon'}
        </h2>
        <p style="font-size: 1.05rem; color: rgba(255,255,255,0.72); max-width: 760px; margin: 0 auto; line-height: 1.55;">
          ${locale === 'en' 
            ? 'A rigorous, in-depth breakdown of the 37 canonical files that govern ABRAXAS OS: from metaphysical roots and 4D state-spaces to production software and the 100-keyframe motion system.' 
            : 'Desglose exhaustivo de los 37 archivos canónicos que gobiernan ABRAXAS OS: desde las raíces metafísicas y el espacio 4D hasta la ingeniería de software y el sistema de 100 keyframes.'}
        </p>
      </div>

      <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(320px, 1fr)); gap: 20px;">
        
        <!-- Group 1: Fundamentos Ontológicos -->
        <div style="background: rgba(255,255,255,0.02); border: 1px solid rgba(212,175,55,0.25); border-radius: 12px; padding: 20px; display: flex; flex-direction: column; gap: 10px;">
          <div style="font-size: 11px; font-family: monospace; color: #d4af37; font-weight: 800; letter-spacing: 0.05em;">📚 I. FUNDAMENTOS ONTOLÓGICOS (00–06)</div>
          
          <div style="border-bottom: 1px solid rgba(255,255,255,0.06); padding-bottom: 8px;">
            <div style="font-weight: 700; color: #fff; font-size: 13px;">00_LEEME_PRIMERO.txt</div>
            <p style="font-size: 12px; color: rgba(255,255,255,0.7); margin: 2px 0 0 0;">Checksum conceptual. Regla de oro: El Árbol describe <i>estados pasivos</i> del contenido; los Módulos son los <i>verbos ejecutivos</i>.</p>
          </div>

          <div style="border-bottom: 1px solid rgba(255,255,255,0.06); padding-bottom: 8px;">
            <div style="font-weight: 700; color: #fff; font-size: 13px;">01_CAPAS_HISTORICAS_Y_METODO.txt</div>
            <p style="font-size: 12px; color: rgba(255,255,255,0.7); margin: 2px 0 0 0;">Diferenciación rigurosa de fuentes: Cábala Judía (Ein Sof), Cristiana (YHSHVH), Hermética Occidental (Dion Fortune) y síntesis ABRAXAS.</p>
          </div>

          <div style="border-bottom: 1px solid rgba(255,255,255,0.06); padding-bottom: 8px;">
            <div style="font-weight: 700; color: #fff; font-size: 13px;">02_CUATRO_MUNDOS_Y_TETRAGRAMATON.txt</div>
            <p style="font-size: 12px; color: rgba(255,255,255,0.7); margin: 2px 0 0 0;">Los Cuatro Mundos como niveles de densidad de datos: Atziluth (Emanación), Beri'ah (Creación), Yetzirah (Formación) y Assiah (Acción).</p>
          </div>

          <div style="border-bottom: 1px solid rgba(255,255,255,0.06); padding-bottom: 8px;">
            <div style="font-weight: 700; color: #fff; font-size: 13px;">03_ARBOL_SEFIROT_PILARES_PATHS.txt</div>
            <p style="font-size: 12px; color: rgba(255,255,255,0.7); margin: 2px 0 0 0;">Topología de las 10 Sefirot y 22 Senderos como red de enrutamiento y balance entre Expansión (Chesed) y Restricción (Gevurah).</p>
          </div>

          <div style="border-bottom: 1px solid rgba(255,255,255,0.06); padding-bottom: 8px;">
            <div style="font-weight: 700; color: #fff; font-size: 13px;">04_DAAT_ABISMO_SHIM.txt</div>
            <p style="font-size: 12px; color: rgba(255,255,255,0.7); margin: 2px 0 0 0;">Da'at como umbral de conciencia activa y metrología. SHIM valida que lo grabado coincida con lo planeado (0.00% GAPs).</p>
          </div>

          <div style="border-bottom: 1px solid rgba(255,255,255,0.06); padding-bottom: 8px;">
            <div style="font-weight: 700; color: #fff; font-size: 13px;">05_YHSHVH_SHIN_CABALA_CRISTIANA.txt</div>
            <p style="font-size: 12px; color: rgba(255,255,255,0.7); margin: 2px 0 0 0;">El Pentagramatón YHSHVH: inserción del fuego de Shin (ש) en el cuerpo físico, materializado en el sellado inmutable CAS SHA-256.</p>
          </div>

          <div>
            <div style="font-weight: 700; color: #fff; font-size: 13px;">06_DION_FORTUNE_QABALAH_OCCIDENTAL.txt</div>
            <p style="font-size: 12px; color: rgba(255,255,255,0.7); margin: 2px 0 0 0;">Traducción de correspondencias planetarias y glifos a esquemas relacionales JSON-Schema, índices SQL y auditoría de software.</p>
          </div>
        </div>

        <!-- Group 2: Arquitectura del Software y Espacio de Estados -->
        <div style="background: rgba(255,255,255,0.02); border: 1px solid rgba(56,189,248,0.25); border-radius: 12px; padding: 20px; display: flex; flex-direction: column; gap: 10px;">
          <div style="font-size: 11px; font-family: monospace; color: #38bdf8; font-weight: 800; letter-spacing: 0.05em;">⚙️ II. ARQUITECTURA & ESPACIO DE ESTADOS (07–15)</div>
          
          <div style="border-bottom: 1px solid rgba(255,255,255,0.06); padding-bottom: 8px;">
            <div style="font-weight: 700; color: #fff; font-size: 13px;">07_XYZA_STATE_SPACE.txt</div>
            <p style="font-size: 12px; color: rgba(255,255,255,0.7); margin: 2px 0 0 0;">Modelo de espacio 4D: Polaridad X, Manifestación Y, Contexto Z y la meta-dimensión A (Memoria cognitiva acumulada).</p>
          </div>

          <div style="border-bottom: 1px solid rgba(255,255,255,0.06); padding-bottom: 8px;">
            <div style="font-weight: 700; color: #fff; font-size: 13px;">08_MODULOS_MUNDOS_OPERADORES.txt</div>
            <p style="font-size: 12px; color: rgba(255,255,255,0.7); margin: 2px 0 0 0;">Definición de los 13 operadores ejecutivos (YOD, HE, SHIM, VAV, ARQUITECTO, etc.) y su dominio funcional específico.</p>
          </div>

          <div style="border-bottom: 1px solid rgba(255,255,255,0.06); padding-bottom: 8px;">
            <div style="font-weight: 700; color: #fff; font-size: 13px;">09_CONTENIDO_CRISTAL_CONTINUITY_AXIS.txt</div>
            <p style="font-size: 12px; color: rgba(255,255,255,0.7); margin: 2px 0 0 0;">Identidad persistente de pieza única: Merkle-DAG sobre SHA-256 anclado al Eje de Continuidad vertical de zafiro.</p>
          </div>

          <div style="border-bottom: 1px solid rgba(255,255,255,0.06); padding-bottom: 8px;">
            <div style="font-weight: 700; color: #fff; font-size: 13px;">10_ATZILUTH_CAMARA_DORADA.txt</div>
            <p style="font-size: 12px; color: rgba(255,255,255,0.7); margin: 2px 0 0 0;">Cámara de emanación pura donde se definen las tesis y los axiomas de marca inmutables antes de instanciar proyectos.</p>
          </div>

          <div style="border-bottom: 1px solid rgba(255,255,255,0.06); padding-bottom: 8px;">
            <div style="font-weight: 700; color: #fff; font-size: 13px;">11_ARQUITECTO_SOL_OJO_LUNA.txt</div>
            <p style="font-size: 12px; color: rgba(255,255,255,0.7); margin: 2px 0 0 0;">La tríada de observabilidad: Sol Primordial (potencial), Ojo de la Pirámide (telemetría en vivo) y Luna (distribución y retorno).</p>
          </div>

          <div style="border-bottom: 1px solid rgba(255,255,255,0.06); padding-bottom: 8px;">
            <div style="font-weight: 700; color: #fff; font-size: 13px;">12_DIMENSION_A_MEMORIA_CRITERIO_OPTIMIZACION.txt</div>
            <p style="font-size: 12px; color: rgba(255,255,255,0.7); margin: 2px 0 0 0;">La ecuación de aprendizaje: S(t+1) = S(t) + A(t). Memoria de linaje, procedencia forense y optimización de ganchos.</p>
          </div>

          <div>
            <div style="font-weight: 700; color: #fff; font-size: 13px;">14_ARQUITECTURA_ESPACIAL_FISICA.txt & 15_REGLAS_CANONICAS.txt</div>
            <p style="font-size: 12px; color: rgba(255,255,255,0.7); margin: 2px 0 0 0;">Geometría física del monumento de 500m (pendiente 51.8487°) y las reglas anti-confusión que garantizan verdad de producto.</p>
          </div>
        </div>

        <!-- Group 3: Sistema de 100 Keyframes y Producción Audiovisual -->
        <div style="background: rgba(255,255,255,0.02); border: 1px solid rgba(168,85,247,0.25); border-radius: 12px; padding: 20px; display: flex; flex-direction: column; gap: 10px;">
          <div style="font-size: 11px; font-family: monospace; color: #c084fc; font-weight: 800; letter-spacing: 0.05em;">🎬 III. SISTEMA DE 100 KEYFRAMES (20–36)</div>
          
          <div style="border-bottom: 1px solid rgba(255,255,255,0.06); padding-bottom: 8px;">
            <div style="font-weight: 700; color: #fff; font-size: 13px;">20_SISTEMA_MOTION_100_KEYFRAMES.txt</div>
            <p style="font-size: 12px; color: rgba(255,255,255,0.7); margin: 2px 0 0 0;">Las 10 secuencias x 10 keyframes. Encadenamiento causal estricto (Frame N toma como base a Frame N-1) para eliminar el drift de IA.</p>
          </div>

          <div style="border-bottom: 1px solid rgba(255,255,255,0.06); padding-bottom: 8px;">
            <div style="font-weight: 700; color: #fff; font-size: 13px;">21–30_PROMPTS_SEQ01_A_SEQ10.txt</div>
            <p style="font-size: 12px; color: rgba(255,255,255,0.7); margin: 2px 0 0 0;">Prompts cinematográficos detallados: SEQ01 (Hero Origin), SEQ04 (Cutaway Árbol), SEQ05 (SHIM Da'at), SEQ06 (VAV Yetzirah), SEQ10 (Luna & Retorno).</p>
          </div>

          <div style="border-bottom: 1px solid rgba(255,255,255,0.06); padding-bottom: 8px;">
            <div style="font-weight: 700; color: #fff; font-size: 13px;">31_MAPA_NARRATIVO_100_IMAGENES.txt</div>
            <p style="font-size: 12px; color: rgba(255,255,255,0.7); margin: 2px 0 0 0;">Storyboard de transición óptica y director de cámara para scroll continuo, parallax e interpolaciones con Three.js.</p>
          </div>

          <div style="border-bottom: 1px solid rgba(255,255,255,0.06); padding-bottom: 8px;">
            <div style="font-weight: 700; color: #fff; font-size: 13px;">32_QA_100_IMAGENES.txt & 33_COMO_USAR.txt</div>
            <p style="font-size: 12px; color: rgba(255,255,255,0.7); margin: 2px 0 0 0;">Protocolo de verificación de integridad estética: lentes anamórficos de 65mm, cero estética cyberpunk barata y consistencia de materiales.</p>
          </div>

          <div>
            <div style="font-weight: 700; color: #fff; font-size: 13px;">34_MASTER_100_IMAGE_PROMPTS & 36_MANIFEST.txt</div>
            <p style="font-size: 12px; color: rgba(255,255,255,0.7); margin: 2px 0 0 0;">Compendio maestro consolidado de 285KB con los 100 prompts y sellos de procedencia criptográfica SHA-256 inmutables.</p>
          </div>
        </div>
