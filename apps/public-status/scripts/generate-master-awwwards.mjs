...
<body class="theme-dark">
  ...
  <main>
    ...
    <p><strong>Luna 2 — Procesos, Gestión de Tareas y Retención:</strong> Satélite operativo que audita en profundidad cómo van los procesos de trabajo y creación, gestiona y asigna las tareas de los empleados (tablero de trabajo), y monitorea las curvas de retención y APV de la audiencia exterior.</p>
    <p><strong>Luna 3 — La Luna Financiera (Costos & Ventas):</strong> Traduce las horas de Luna 2 en costos financieros de producción ($/pieza y $/campaña), audita ventas tanto a nivel de <strong>Campaña General</strong> como de <strong>Publicación Individual</strong>, ingesta facturas y tickets con el escáner OCR on-device y calcula el ROI real.</p>
