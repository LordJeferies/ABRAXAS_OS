...
<body class="theme-dark">
  ...
  <main>
    ...
    <!-- 7. SECTION: HARDWARE & RENDIMIENTO M-SERIES -->
    <section id="performance" class="section-wrap" style="padding-top: 80px;">
      <div class="section-head" style="text-align: center;">
        ...
        <p class="p">${isEs ? 'Aprovechamiento determinista de los motores de hardware ProRes, Neural Engine de 16 núcleos y arquitectura de memoria unificada UMA.' : 'Deterministic hardware acceleration via ProRes engines, 16-core Neural Engine and UMA memory.'}</p>
      </div>

      <div class="bento-grid">
        <div class="spotlight-card col-4" style="position: relative;">
          <button class="card-expand-btn" title="Expandir">+</button>
          <span class="card-pill-tag cyan">MEDIA ENGINE ACCEL</span>
          <h4 class="card-h3">VideoToolbox ProRes & HEVC</h4>
          <p class="card-desc">Renderizado de videos 9:16 y 16:9 en tiempo récord mediante aceleradores dedicados de hardware sin saturar la CPU.</p>
          <div class="card-deepdive-drawer">
            <div class="deepdive-content-box">
        ...
        <div class="spotlight-card col-4" style="position: relative;">
          ...
          <p class="card-desc">Transcripción fonética continua y sincronización de subtítulos a 40ms sin enviar un solo byte de audio a servidores externos.</p>
          <div class="card-deepdive-drawer">
            <div class="deepdive-content-box">
              <span class="deepdive-tag">PRIVACIDAD & SOBERANÍA</span>
              <p>Modelos cuantizados CoreML ejecutados en el Apple Neural Engine (ANE). Tu voz, estrategias y borradores permanecen 100% soberanos y confidenciales dentro de tu máquina.</p>
            </div>
          </div>
        </div>
        ...
        <div class="spotlight-card col-4" style="position: relative;">
          <button class="card-expand-btn" title="Expandir">+</button>
          <span class="card-pill-tag emerald">UNIFIED MEMORY (UMA)</span>
          <h4 class="card-h3">Almacenamiento CAS Cero-Copia</h4>
          <p class="card-desc">Transmisión de texturas y clips de video entre CPU, GPU y Neural Engine sin cuellos de botella de bus PCIe.</p>
          <div class="card-deepdive-drawer">
            <div class="deepdive-content-box">
              <span class="deepdive-tag">RENDIMIENTO CRIPTOGRÁFICO</span>
              <p>Almacenamiento direccionado por contenido (CAS) con hashes SHA-256 calculados directamente en registros ARMv8 Crypto Extensions.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- 8. SECTION: GOBERNANZA & ALTA DIRECCIÓN HE -->
    <section id="governance" class="section-wrap" style="padding-top: 80px;">
      <div class="section-head" style="text-align: center;">
        ...
        <p class="p">${isEs ? 'Un solo operador con criterio comanda una fábrica de contenido entera con persistencia SQLite soberana y telemetría de costos.' : 'A single sovereign operator commands an entire content factory with local SQLite persistence.'}</p>
      </div>
      ...
      <div class="bento-grid">
        <div class="spotlight-card col-6" style="position: relative;">
          ...
          <h4 class="card-h3">Flujo Operativo de 6 Compuertas Inmutables</h4>
          <p class="card-desc">De SEMILLA a PRODUCTION y PUBLISHED: cada activo debe superar auditorías estrictas de audio, márgenes WCAG y directiva no_sfx.</p>
          <div class="card-deepdive-drawer">
            <div class="deepdive-content-box">
        ...
        <div class="spotlight-card col-6" style="position: relative;">
          ...
          <h4 class="card-h3">Base de Datos SQLite metrics.db</h4>
          <p class="card-desc">Control exacto de costos de cómputo local, tiempo de producción por pieza y cálculo matemático de ROI sin suscripciones mensuales.</p>
          <div class="card-deepdive-drawer">
            <div class="deepdive-content-box">
              <span class="deepdive-tag">SCHEMA RELACIONAL</span>
              <p>Tablas inmutables: assets, renders, discrepancies, sales_ledger y closers_performance. Reportes automáticos exportables en CSV, JSON y PDF.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- 9. SECTION: CÁTEDRA FORMAL 165 IQ -->
    <section id="catedra" class="section-wrap" style="padding-top: 80px;">
      <div class="section-head" style="text-align: center;">
        ...
        <p class="p">${isEs ? 'Fundamentación matemática rigurosa: máquinas de estado finitas delta(s, e), espacios de Hilbert y teoría de la información aplicadas al contenido.' : 'Rigorous mathematical foundation: state machines, Hilbert spaces and information theory.'}</p>
      </div>
      ...
      <div class="bento-grid">
        <div class="spotlight-card col-6" style="position: relative;">
          ...
          <h4 class="card-h3">Transiciones Deterministas delta(s, e)</h4>
          <p class="card-desc">El contenido evoluciona a través de estados formalmente definidos y verificables sin saltos caóticos.</p>
          <div class="card-deepdive-drawer">
            <div class="deepdive-content-box">
              <span class="deepdive-tag">AUTOMATA FINITO</span>
        ...
        <div class="spotlight-card col-6" style="position: relative;">
          ...
          <h4 class="card-h3">Espacios de Hilbert y Producto Punto</h4>
          <p class="card-desc">La coherencia entre la voz de marca (Brand Core) y las frases generadas se mide matemáticamente mediante distancia de cosenos.</p>
          <div class="card-deepdive-drawer">
            <div class="deepdive-content-box">
      ...
      <div style="text-align: center; margin-top: 2rem;">
        <a href="${langPrefix}catedra/index.html" class="btn-apple-cta" style="background: rgba(56,189,248,0.2); border: 1px solid var(--color-cyan);">${isEs ? 'Leer Tratado Completo de la Cátedra ➔' : 'Read Complete Formal Lecture ➔'}</a>
      </div>
    </section>

    <!-- 10. SECTION: SCRUM BACKLOG 0 A 100% -->
    <section id="scrum" class="section-wrap" style="padding-top: 80px;">
      <div class="section-head" style="text-align: center;">
        ...
        <p class="p">${isEs ? 'El camino riguroso paso a paso para construir, validar y desplegar ABRAXAS OS en tu Mac con cero cabos sueltos:' : 'Step-by-step rigorous path to build, validate and deploy ABRAXAS OS on your Mac:'}</p>
      </div>
      ...
      <div style="text-align: center; margin-top: 2.5rem; display: flex; justify-content: center; gap: 15px; flex-wrap: wrap;">
        <a href="${langPrefix}scrum/index.html" class="btn-apple-cta" style="background: var(--color-gold); color: #000; font-weight: 700; padding: 12px 28px;">${isEs ? '📋 Abrir Backlog Scrum Completo en Página Dedicada ➔' : '📋 Open Complete Dedicated Scrum Page ➔'}</a>
