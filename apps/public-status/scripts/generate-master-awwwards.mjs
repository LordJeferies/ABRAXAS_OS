...
<body class="theme-dark">
  ...
  <main>
    ...
    <p><strong>Luna 3 — La Luna Financiera (Costos & Ventas):</strong> Traduce las horas y tareas de Luna 2 en costos financieros de producción ($/pieza y $/campaña), ingesta facturas y comprobantes con el escáner OCR on-device y calcula el ROI de ventas exacto.</p>
