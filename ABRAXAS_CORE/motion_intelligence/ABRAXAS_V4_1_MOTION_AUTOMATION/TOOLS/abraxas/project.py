...
def make_project_config(project_id,content_html,intro_html,vertical_master,horizontal_master,output_root):
    return {
      'schema_version':'abraxas.executable.project.v4.1','project_id':project_id,'output_version':'V4_1','preserve_legacy':True,
      ...
      'motion':{'enabled':True,'strict_assets':False,'selection_overrides':{},'preview_encoder':'h264_videotoolbox'},
      'davinci':{'revision':'V4_1','fps':30,'protect_existing_timelines':True},
