...
echo "=========================================="
echo "⚡ ABRAXAS OS — MASTER TRIPLE-DEPLOY CONTROLLER"
echo "=========================================="

# 1. Build latest status assets
echo "📦 [1/4] Rebuilding status website & Canon 37 TXT library..."
...
echo "🚀 Root Domain URL: https://lordjeferies.github.io/es/index.html [HTTP $HTTP_ROOT]"
